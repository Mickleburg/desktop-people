    ...
    double GrabChance = 0)
{
    ...
    private static CharacterBehaviorTuning ForLevel(int level) => level switch
    {
        0 => new CharacterBehaviorTuning(
            ...
            JumpChance: 0.02, ClimbChance: 0.10, HideChance: 0.30, GrabChance: 0.35),
        2 => new CharacterBehaviorTuning(
            1.4, 4.5, 3.0, 1.8, 0.10, 0.45,
            JumpChance: 0.12, ClimbChance: 0.32, HideChance: 0.08, GrabChance: 0.55),
        _ => new CharacterBehaviorTuning(
            2.4, 3.8, 2.2, 3.2, 0.25, 0.20,
            JumpChance: 0.05, ClimbChance: 0.20, HideChance: 0.18, GrabChance: 0.45),
    };
