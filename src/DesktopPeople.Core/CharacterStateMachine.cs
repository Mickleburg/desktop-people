...
public sealed class CharacterStateMachine
{
    ...
    private static CharacterState Resolve(CharacterState current, CharacterSignal signal) =>
        (current, signal) switch
        {
            ...
            (CharacterState.Idle, CharacterSignal.JumpRequested) => CharacterState.Fall,
            ...
            (CharacterState.Walk, CharacterSignal.ClimbRequested) => CharacterState.Climb,
            (CharacterState.Walk, CharacterSignal.HideRequested) => CharacterState.Hide,
            (CharacterState.Walk, CharacterSignal.JumpRequested) => CharacterState.Fall,
            ...
            (CharacterState.Run, CharacterSignal.ClimbRequested) => CharacterState.Climb,
            (CharacterState.Run, CharacterSignal.HideRequested) => CharacterState.Hide,
            (CharacterState.Run, CharacterSignal.JumpRequested) => CharacterState.Fall,
            (CharacterState.Sit, CharacterSignal.StandRequested) => CharacterState.Idle,
            (CharacterState.Climb, CharacterSignal.Landed) => CharacterState.Idle,
            (CharacterState.Fall, CharacterSignal.ClimbRequested) => CharacterState.Climb,
            (CharacterState.Hide, CharacterSignal.ClimbRequested) => CharacterState.Climb,
            _ => current,
        };
}
